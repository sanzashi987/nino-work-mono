import { DeltaKey, FileType, ComInfo } from '@/types';
import { uuid } from './uuid';
import { ActiveDescriber } from '@/types/stateless';
...
export const parseCrossPanelId = (input: string) => {
 ...
 * @returns
 */
export function composePackageKey(params: PackageKeyComposer) {
...
/** 基于面板id,组件id生成新的事件名称 */
export function composeDataEventName(
  basename: string,
